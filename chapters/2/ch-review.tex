...
\begin{enumerate}
    ...
    \item Representing Audio (earlier in the process - not meant to be exhaustive by any means, but probably need to start by explaining that we need a way to represent audio digitally -- and that this is very much an open question)
...
\subsubsection{Search vs. Modelling}
