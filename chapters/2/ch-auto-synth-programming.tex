...
\section{Approaches}
In an automatic synthesizer programming system the result is typically an additional layer of abstraction on top of the control interface. The goal of this abstraction is to bridge the conceptual
