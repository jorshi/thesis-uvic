...
% In the previous chapter, some of the specific challenges in synthesizer programming were identified along with the desire for improved user interfaces and tools to support programming. The field of automatic synthesizer 
...
% How to focus this on the human interaction problem? 
...
- Talk about this as an interaction problem, tie in creativity support tools in this section as well as music interaction.
