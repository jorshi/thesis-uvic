...
The use of sound synthesizers in the fields of music composition, production, and performance is widespread, but the task of programming a synthesizer is complex and requires a thorough understanding of technical details. It is not uncommon for a software synthesizer to have 30+ parameters displayed on a user interface (UI) and labelled using technical names \cite{rasmussen2018evaluating}. Programming a synthesizer involves the manual adjusting of this large set of parameters to achieve some goal sound, which may or may not be defined clearly beforehand. This is a daunting task for anyone, let alone a novice to the task. Synthesizer programming is further complicated by the fact that modifications to parameters are often not intuitively reflected in the end sonic result. This disconnect can be disruptive to the creative process.

This thesis is focused on supporting the development of methods and applications that make synthesizer programming more accessible with the goal of enabling more people to be creative more often. The benefit of being able to express creatively on a regular basis has been proven \cite{conner2018everyday} and technology that enables individuals to experience themselves as creative in an area that was traditionally unavailable to them is empowering \cite{tavana2015democracy}. New synthesizers are constantly being developed and are now widely accessible on consumer devices including mobile phones. Developing methods that encourage the use of these synthesizers has the potential to lower the barrier of entry and support users in expressing in creative ways more regularly. Experienced synthesizer users have also identified synthesizer programming as challenging to learn and an impediment to the creative process of writing music \cite{krekovic2014intelligent}. 

[Tie this into automatic synthesizer programming somehow now?]
Technology derived from automatic synthesizer programming 

Automatic synthesizer programming is the field of research focused on addressing these challenges in programming synthesizers. 

Since the late 1970s a steady stream of work has contributed to the body of automatic synthesizer programming research, bolstered by developments in adjacent fields including digital signal processing, human computer interaction, artificial intelligence, and machine learning. As a result, the field of automatic synthesizer programming is an inherently interdisciplinary pursuit.
...
Enabling more people to be creative! In a leap I am going to claim that playing a synthesizer is good for your well-being. 

Benefits of being creative? (https://www.tandfonline.com/doi/abs/10.1080/17439760.2016.1257049) -- 
