...
The following subsections describe each of the models in more detail and the specifics of each architecture is provided in appendix \ref{appendix:spiegelib_models}.
