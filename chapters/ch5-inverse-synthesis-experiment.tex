...
\begin{itemize}
    ...
    \item \textbf{RQ2}: How do RNNs compare to CNNs for inverse synthesis? Does the Mel-spectrogram help the CNN to learn more accurately?
    \item \textbf{RQ3}: Are the GAs able to produce competitive results when constrained to a limited number of generations to improve efficiency?
    \item \textbf{RQ4}: Are certain synthesis parameters more easily learned? How does the ability to predict parameters correlate with audio results?
\end{itemize}
...
\subsection{Recurrent vs. Convolutional Networks}
