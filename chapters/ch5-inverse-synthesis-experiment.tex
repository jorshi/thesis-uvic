...
Results of the this experiment also reveal a key aspect regarding the complexity of the synthesizer parameter space and its relationship to auditory results. Specifically, the results showed that there is redundancy in the parameter space that is conditional on the values other parameters. In other words, there may be more than one, and potentially many, different parameter settings that produce the same or similar auditory results. This points to the complexity of mapping between synthesizer parameters and auditory results -- even in the case of the reduced seven parameter synthesizer used in this experiment. Developing a deeper insight into the relationship between synthesizer parameters and the associated auditory result will be important for furthering research on automatic synthesizer programming.
